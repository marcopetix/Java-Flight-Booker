...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        login_panel.setPreferredSize(new java.awt.Dimension(250, 312));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(login_panel, javax.swing.GroupLayout.DEFAULT_SIZE, 270, Short.MAX_VALUE)
        );
    ...
    private void login_submit_buttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_login_submit_buttonMouseClicked
        ...
        if(token == null){
            ...
            try {
                new Interfaccia(token, username).setVisible(true);
